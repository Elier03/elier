    ...
    try:
        ...
        if '/start' in msgText:
            ...
            #    
                # set in debug
            #    api_id = 16176386
            #    api_hash = 'c84c074d52ccaba63e08623105b4c373f'
            #    bot_token = '5440828172:AAHRjODwLhOCwMzMYfID36rWbohq3xb_ifk'
...
def main():
    bot_token = os.environ.get('5440828172:AAHRjODwLhOCwMzMYfID36rWbohq3xb_ifk')
